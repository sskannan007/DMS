...
import { FileText, Clock, FileSignature, BarChart3 } from "lucide-react";
import { AppLayout } from "../components/AppLayout";
import { getRecentSearches, clearRecentSearches, initRecentSearchesIfEmpty } from "../utils/recentSearches";
import { getRecentDocuments, clearRecentDocuments } from "../utils/recentDocuments";
...
const quickFilters = [
  ...
  { name: "Current Documents", countKey: "current", icon: FileText },
...
export function DashboardPage() {
  ...
  const [recentDocuments, setRecentDocuments] = useState(() => getRecentDocuments());
                ...
                >
                  ...
                  <Card.Body className="p-0">
                    ...
                    <div className="h5 fw-bold mb-1 quick-filter-count" style={{ color: "var(--foreground)" }}>
                      {filter.countKey === "current" ? documents.length.toLocaleString() : filter.count}
                    </div>
                    ...
                    <div className="d-flex gap-2 gap-sm-3 align-items-start">
                      ...
                      <div className="flex-grow-1 min-w-0 overflow-hidden">
                        ...
                        <div className="d-flex flex-wrap align-items-center gap-1 gap-sm-2 small text-muted">
                          {doc.date && <span>{doc.date.slice(0, 4)}</span>}
                          {doc.date && doc.type && <span>·</span>}
